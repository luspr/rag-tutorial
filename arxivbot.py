...
from ai import chat_completion, llm_complete, PageEmbeddingStr, get_embedding, rank_embeddings
...
def prompt_per_page(relevant_pages: Dict[str, List[DocumentPage]], query: str):
    """Extract the parameters from the relevant pages."""
...
def main():
    ...
    corpus = Corpus(args.input_path)#'data/val/*pdf')
    if args.question:
